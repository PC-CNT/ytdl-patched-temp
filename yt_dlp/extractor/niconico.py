...
class NiconicoIE(NiconicoBaseIE):
    ...
    def _get_subtitles(self, video_id, api_data):
        ...
        new_danmaku = json.dumps(new_danmaku)
        danmaku = load_comments(new_danmaku, 'NiconicoJson', w, h, report_warning=self.report_warning)
        xml_danmaku = convert_niconico_json_to_xml(new_danmaku)
        return {
            'jpn': [{
                'ext': 'json',
                'data': new_danmaku,
